...
describe('domain-boundaries: BILLING_CYCLE_STATUSES', () => {
  it('contains exactly the schema BillingPeriodStatus values', () => {
    // The schema enum BillingPeriodStatus = OPEN | LOCKED | CLOSED (3 values)
    // BILLING_CYCLE_STATUSES mirrors this enum — it is NOT the old BillingCycleStatus
    // which had 5 values (OPEN, IMPORTED, LOCKED, INVOICED, CLOSED).
