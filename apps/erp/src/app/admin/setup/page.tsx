...
import { OnlyOfficeStep } from './steps/OnlyOfficeStep';
  ...
  function validateStep(step: number): boolean {
    ...
    switch (step) {
      ...
      case 2: // Building & Rooms
        ...
        if (state.rooms.format === 'CUSTOM_PREFIX' && !state.rooms.prefix) {
    ...
    try {
      const payload = {
        ...
        rooms: {
          ...
          prefix: state.rooms.prefix || undefined,
          mixedSpecialFloor: state.rooms.mixedSpecialFloor || undefined,
        },
        billing: {
    ...
    <main className="min-h-screen bg-surface-container-lowest py-6 px-4">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="rounded-2xl border border-outline-variant/10 bg-surface-container-lowest p-6 shadow-sm">
          ...
          {state.currentStep === 4 && (
            <OnlyOfficeStep onSkip={nextStep} />
          )}
