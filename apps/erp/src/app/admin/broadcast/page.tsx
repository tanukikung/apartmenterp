...
export default function BroadcastPage() {
  ...
  async function handleSend() {
    if (selectedIds.size === 0 && sendType === 'SELECTED') {
      alert('กรุณาเลือกใบแจ้งหนี้ที่ต้องการส่ง');
      return;
    }
  ...
  const stats = {
    ...
    sent: overdueInvoices.filter((i) => i.lastReminderAt).length,
  };
    ...
    <main className="space-y-6">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary-container to-primary px-6 py-5 shadow-lg">
        ...
        <div className="relative flex items-center justify-between gap-4">
          <div>
            <h1 className="text-base font-semibold text-on-primary">Broadcast & Reminder Center</h1>
        ...
        <section className="space-y-4">
          <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 overflow-hidden">
            ...
            <div className="space-y-4 p-4">
              ...
              <div className="rounded-lg border border-warning/30 bg-warning-container p-3 text-sm text-on-warning-container">
          ...
          {result && (
            <div className="bg-success-container rounded-xl border border-success/30 overflow-hidden">
