        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select value={fromMonth} onChange={(e) => setFromMonth(Number(e.target.value))}
              ...
              {MONTHS.map((m) => <option key={m} value={m}>{new Date(2000, m - 1).toLocaleString('en', { month: 'short' })}</option>)}
            </select>
    ...
    <main className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary-container to-primary px-6 py-5 shadow-lg">
        ...
        <div className="relative flex items-center justify-between">
          ...
          <button onClick={() => {}} className="inline-flex items-center gap-2 rounded-lg bg-white/20 px-4 py-2 text-sm font-semibold text-on-primary shadow-sm transition-colors hover:bg-white/30">
