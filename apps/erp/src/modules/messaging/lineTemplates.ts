...
function buildInvoiceFlex(data: InvoiceTemplateData): object {
  return {
    type: 'bubble',
    hero: {
      type: 'image',
...
function buildReminderFlex(data: ReminderTemplateData): object {
...
function buildReceiptFlex(data: ReceiptTemplateData): object {
  return {
    type: 'bubble',
    body: {
      type: 'box',
