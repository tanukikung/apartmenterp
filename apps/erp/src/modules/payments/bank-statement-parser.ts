...
export class BankStatementParser {
  ...
  private parseRow(
    ...
    return {
      ...
      time,
      amount,
      description: columns.descCol ? (row[columns.descCol] as unknown as string | undefined)?.toString().trim() : undefined,
      reference: columns.refCol ? (row[columns.refCol] as unknown as string | undefined)?.toString().trim() : undefined,
    };
  }
