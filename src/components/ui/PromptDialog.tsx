      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <input
              type="text"
              className="mt-1.5 w-full rounded-lg border border-outline bg-surface-container-lowest px-3 py-2 text-sm text-on-surface placeholder:text-on-surface-variant/50 transition-all focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            ...
            <div className="mt-5 flex gap-3 justify-end">
              ...
              <motion.button
                ...
                disabled={loading}
                className="inline-flex items-center gap-2 rounded-lg border border-primary bg-primary px-4 py-2 text-sm font-semibold text-on-primary shadow-sm shadow-primary/30 transition-colors hover:bg-primary/90 disabled:opacity-50"
              >
                {loading ? (
