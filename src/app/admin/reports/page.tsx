...
export default function AdminReportsPage() {
  ...
  return (
    <main className="space-y-6">
      {/* Page header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-container via-primary to-indigo-500 px-6 py-6 shadow-lg">
        ...
        <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-on-primary/86">
          ...
          <button onClick={() => window.location.reload()} className="inline-flex items-center gap-2 rounded-xl bg-white/20 px-4 py-2 text-sm font-semibold text-on-primary shadow-sm transition-colors hover:bg-white/30">
      ...
      {/* Tab Switcher */}
      <div className="rounded-2xl border border-outline-variant/25 bg-surface-container-lowest p-3 shadow-sm">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-[0.12em] text-on-surface-variant">มุมมองรายงาน</div>
            <p className="mt-1 text-sm text-on-surface-variant">{activeTabMeta.description}</p>
          </div>
          <div className="inline-flex flex-wrap items-center gap-1 rounded-xl bg-surface-container p-1">
            {TABS.map((tab) => (
