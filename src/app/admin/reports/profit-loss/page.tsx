...
export default function AdminProfitLossPage() {
  ...
  return (
    <main className="space-y-6">
      ...
      {/* Error */}
      {error && (
        <div className="px-4 py-3 rounded-lg bg-error-container/10 border border-error-container/20 text-sm text-[var(--color-danger)] font-medium flex items-center gap-2">
