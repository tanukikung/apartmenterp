          ...
          <div
            ...
            className={`flex min-h-[200px] cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed px-6 py-10 text-center transition-all ${
              file
                ...
                : 'border-outline hover:border-primary50 hover:bg-surface-container'
            }`}
          >
            <input
              ref={fileRef}
          ...
          <table className="min-w-full text-sm">
            <thead>
              <tr className="border-b border-outline-variant">
                <th className="whitespace-nowrap px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-on-surface-variant">คอลัมน์</th>
                <th className="whitespace-nowrap px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-on-surface-variant">ต้องระบุ</th>
                <th className="whitespace-nowrap px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-on-surface-variant">คำอธิบาย</th>
                <th className="whitespace-nowrap px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-on-surface-variant">ตรวจจับชื่ออัตโนมัติ</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-outline-variant/5">
                <td className="px-4 py-3 font-semibold text-on-surface">วันที่</td>
                <td className="px-4 py-3"><span className="inline-flex items-center rounded-full bg-error-container px-2.5 py-0.5 text-xs font-semibold text-on-error-container">ต้องระบุ</span></td>
                <td className="px-4 py-3 text-on-surface-variant">วันที่ธุรกรรม</td>
                <td className="px-4 py-3 text-on-surface-variant/60">date, วันที่</td>
              </tr>
              <tr className="border-b border-outline-variant/5">
                <td className="px-4 py-3 font-semibold text-on-surface">จำนวน</td>
                <td className="px-4 py-3"><span className="inline-flex items-center rounded-full bg-error-container px-2.5 py-0.5 text-xs font-semibold text-on-error-container">ต้องระบุ</span></td>
                <td className="px-4 py-3 text-on-surface-variant">จำนวนธุรกรรม</td>
                <td className="px-4 py-3 text-on-surface-variant/60">amount, จำนวนเงิน, debit, credit, deposit, withdraw</td>
              </tr>
              <tr className="border-b border-outline-variant/5">
                <td className="px-4 py-3 font-semibold text-on-surface">รายละเอียด</td>
                <td className="px-4 py-3"><span className="inline-flex items-center rounded-full bg-surface-container px-2.5 py-0.5 text-xs font-semibold text-on-surface-variant">ไม่บังคับ</span></td>
                <td className="px-4 py-3 text-on-surface-variant">รายละเอียดธุรกรรม</td>
                <td className="px-4 py-3 text-on-surface-variant/60">description, รายละเอียด, detail, narrative</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-on-surface">อ้างอิง</td>
                <td className="px-4 py-3"><span className="inline-flex items-center rounded-full bg-surface-container px-2.5 py-0.5 text-xs font-semibold text-on-surface-variant">ไม่บังคับ</span></td>
                <td className="px-4 py-3 text-on-surface-variant">หมายเลขอ้างอิง</td>
        ...
        <div className="bg-surface-container-lowest rounded-xl border border-on-tertiary-container/20 overflow-hidden">
          ...
          <div className="grid gap-4 p-6 pt-0 sm:grid-cols-2 xl:grid-cols-4">
            <div className="bg-surface-container rounded-xl p-4">
              <p className="text-xs font-medium uppercase tracking-wide text-on-surface-variant">รายการทั้งหมด</p>
              <p className="mt-1 text-2xl font-bold text-on-surface">{result.totalEntries}</p>
            </div>
            <div className="bg-surface-container rounded-xl p-4">
              <p className="text-xs font-medium uppercase tracking-wide text-on-surface-variant">นำเข้าแล้ว</p>
              <p className="mt-1 text-2xl font-bold text-on-tertiary-container">{result.imported}</p>
            </div>
            <div className="bg-surface-container rounded-xl p-4">
              <p className="text-xs font-medium uppercase tracking-wide text-on-surface-variant">จับคู่อัตโนมัติ</p>
              <p className="mt-1 text-2xl font-bold text-primary">{result.matched}</p>
            </div>
            <div className="bg-surface-container rounded-xl p-4">
              <p className="text-xs font-medium uppercase tracking-wide text-on-surface-variant">ต้องตรวจสอบ</p>
