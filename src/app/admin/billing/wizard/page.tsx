...
export default function BillingWizardPage(): JSX.Element {
  ...
  return (
    <main className="space-y-6 max-w-3xl mx-auto">
      ...
      {/* Alerts */}
      {error && (
        <div className="flex items-center gap-3 rounded-xl bg-error-container/10 border border-error-container/20 px-4 py-3 text-sm text-[var(--color-danger)] font-medium">
