    ...
    <main className="space-y-6">
        ...
        <section className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 border-emerald-200 bg-emerald-50/70">
          <div className="flex flex-col gap-5 p-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-emerald-900">นำเข้าเสร็จสมบูรณ์</h2>
      ...
      {confirmDialogOpen && preview ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          />
          {/* Dialog */}
          <div className="relative z-10 w-full max-w-lg rounded-2xl border border-outline-variant/20 bg-surface-container-lowest p-6 shadow-2xl">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-100">
                <AlertTriangle className="h-6 w-6 text-amber-600" />
              </div>
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-on-surface">ยืนยันการนำเข้า?</h3>
                <p className="mt-1 text-sm text-on-surface-variant">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              <div className="rounded-lg border border-outline-variant/10 bg-surface-container p-3 text-center">
                <div className="text-xs text-on-surface-variant">ห้อง</div>
                <div className="mt-1 text-lg font-semibold text-on-surface">{totals.rooms}</div>
              </div>
              <div className="rounded-lg border border-outline-variant/10 bg-surface-container p-3 text-center">
                <div className="text-xs text-on-surface-variant">ยอดรวม</div>
                <div className="mt-1 text-lg font-semibold text-on-surface">{money(totals.totalAmount)}</div>
              </div>
              <div className="rounded-lg border border-outline-variant/10 bg-surface-container p-3 text-center">
                <div className="text-xs text-on-surface-variant">คำเตือน</div>
