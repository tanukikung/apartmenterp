              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-2 mb-4">
                  ...
                  <span className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-[10px] font-bold ${
                    room.roomStatus === 'VACANT' ? 'bg-emerald-100 text-emerald-700' :
                    room.roomStatus === 'OCCUPIED' ? 'bg-blue-100 text-blue-700' :
                    room.roomStatus === 'MAINTENANCE' ? 'bg-amber-100 text-amber-700' :
                    'bg-purple-100 text-purple-700'
                  }`}>
                    <span className={`w-1.5 h-1.5 rounded-full ${
                      room.roomStatus === 'VACANT' ? 'bg-emerald-500' :
                      room.roomStatus === 'OCCUPIED' ? 'bg-blue-500' :
