  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex gap-3 items-center">
        <div className="h-10 w-64 bg-[hsl(var(--color-surface-hover))] rounded-lg" />
        <div className="h-8 w-20 bg-[hsl(var(--color-surface-hover))] rounded-full" />
        <div className="h-8 w-24 bg-[hsl(var(--color-surface-hover))] rounded-full" />
        <div className="h-8 w-20 bg-[hsl(var(--color-surface-hover))] rounded-full" />
        <div className="h-8 w-28 bg-[hsl(var(--color-surface-hover))] rounded-full" />
        <div className="flex-1" />
        <div className="h-10 w-10 bg-[hsl(var(--color-surface-hover))] rounded-lg" />
      </div>
