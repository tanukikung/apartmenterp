        ...
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="text-xl font-semibold text-on-surface mt-0.5">{isLoading ? '...' : totals.floors}</div>
            </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="text-xl font-semibold text-on-surface mt-0.5">{isLoading ? '...' : totals.rooms}</div>
            </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="text-xl font-semibold text-on-surface mt-0.5">{isLoading ? '...' : totals.active}</div>
            </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 p-5">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="text-xl font-semibold text-on-surface mt-0.5">{isLoading ? '...' : totals.inactive}</div>
            </div>
