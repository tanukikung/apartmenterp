                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-lg border border-outline bg-surface-container-lowest p-2 text-xs text-[var(--color-danger)] transition-colors hover:bg-error-container/10"
                            title="ลบ"
                          >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-lg rounded-2xl bg-surface-container-lowest p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          {error && (
            <div className="px-4 py-3 rounded-lg bg-error-container/10 border border-error-container/20 text-sm text-[var(--color-danger)]">
              {error}
            </div>
          )}
