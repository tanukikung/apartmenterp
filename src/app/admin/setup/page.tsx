        ...
        {!submitResult && state.currentStep === 5 && (
          <div className="flex items-center justify-between">
            <button
              onClick={prevStep}
              disabled={submitting}
              className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-white/70 hover:bg-white/10 hover:scale-105 active:scale-[0.98] transition-all disabled:opacity-50"
            >
              <ArrowLeft className="h-4 w-4" />
              กลับ
            </button>
