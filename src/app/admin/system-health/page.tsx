...
function globalBadgeClass(status: 'ok' | 'degraded' | 'error' | undefined): string {
  ...
  if (status === 'error') return 'inline-flex items-center gap-2 rounded-full bg-error-container/30 px-3 py-1 text-xs font-semibold text-[var(--color-danger)]';
...
export default function SystemHealthPage() {
  ...
  if (error && !data) {
    return (
      <main className="space-y-6">
        ...
        <div className="rounded-xl border border-[var(--color-danger)]/30 bg-error-container/20 px-4 py-3 text-sm text-[var(--color-danger)]">{error}</div>
      </main>
    );
  }
  ...
  return (
    <main className="space-y-6">
        ...
        <div className="relative flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {alerts.filter((a) => a.severity === 'critical' || a.severity === 'warning').length > 0 ? (
              <span className="inline-flex items-center gap-2 rounded-full bg-error-container/30 px-3 py-1 text-xs font-semibold text-[var(--color-danger)]">
      ...
      {error ? <div className="rounded-xl border border-[var(--color-danger)]/30 bg-error-container/20 px-4 py-3 text-sm text-[var(--color-danger)]">{error}</div> : null}
      ...
      {/* ── Alerts panel ─────────────────────────────────────────────── */}
      {alerts.length > 0 ? (
        <section className="rounded-xl border border-[var(--color-danger)]/30 bg-error-container/10 px-4 py-3">
              ...
              <div
                ...
                className={[
                  ...
                  alert.severity === 'critical'
                    ? 'bg-error-container/40 border border-[var(--color-danger)]/20'
              ...
              <div
                className={[
                  ...
                  outbox.failedCount > 0
                    ? 'border-[var(--color-danger)]/30 bg-error-container/20'
              ...
              >
                ...
                <div
                  className={[
                    ...
                    outbox.failedCount > 0 ? 'text-[var(--color-danger)]' : 'text-on-surface',
                  ].join(' ')}
                >
                  {outbox.failedCount}
                </div>
